...
const addOne = (arr) => {
  let arr2 = [];
  arr.forEach(num => arr2.push(num + 1));
  return arr2;
};
...
const allUpperCase = (arr) => {
  let arr2 = [];
  arr.forEach(str => arr2.push(str.toUpperCase()));
  return arr2;
};
...
const greeting = (word) => {
  let strArr = [];
  word.forEach(str => strArr.push(str.toUpperCase, + '!'));
  return strArr;
};

const speaker = (words, callback) => {
  let words2 = [];
  words.forEach(greet => words2.push(greet, callback));
  return words2;
};
